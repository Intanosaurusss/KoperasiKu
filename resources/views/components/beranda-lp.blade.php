...
<body>
<section id="beranda" class="bg-white" data-aos="zoom-in">
    <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        ...
        <div class="mt-4 md:mt-0">
            ...
            <a href="login" class="inline-flex items-center justify-center text-center text-purple-400 border-2 border-purple-400 hover:text-white hover:bg-purple-400 font-medium rounded-full text-sm py-2 w-auto transition ease-in-out duration-300">
                Mulai
