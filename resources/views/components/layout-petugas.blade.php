        ...
        <div 
            ...
            <nav class="">
                ...
                <a href="{{ route('pages-petugas.dashboard-petugas') }}" class="block">
                    <li class="flex items-center px-4 py-2 hover:bg-purple-200 rounded-xl space-x-4 {{ request()->is('dashboard-petugas') ? 'bg-purple-400 text-white' : 'hover:bg-purple-300' }}">
                ...
                <a href="{{ route('produk-petugas.index') }}" class="block">
                    <li class="flex items-center px-4 py-2 hover:bg-purple-200 rounded-xl space-x-4 {{ request()->is('produk-petugas') ? 'bg-purple-400 text-white' : 'hover:bg-purple-300' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-5 w-5">
                ...
                <a href="{{ route('pages-petugas.member-petugas') }}" class="block">
                        <li class="flex items-center mx-1 px-4 py-2 hover:bg-purple-200 rounded-xl space-x-4 {{ request()->is('member-petugas') ? 'bg-purple-400 text-white' : 'hover:bg-purple-300' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-5 w-5">
                ...
                <a href="{{ route('transaksi-petugas.index') }}" class="block">
                    <li class="flex items-center px-4 py-2 hover:bg-purple-200 rounded-xl space-x-4 {{ request()->is('transaksi-petugas') ? 'bg-purple-400 text-white' : 'hover:bg-purple-300' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-5 w-5">
                ...
                <a href="{{ route('riwayat-petugas.index') }}" class="block">
                    <li class="flex items-center px-4 py-2 hover:bg-purple-200 rounded-xl space-x-4 {{ request()->is('riwayat-petugas') ? 'bg-purple-400 text-white' : 'hover:bg-purple-300' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-5 w-5">
                ...
                <a href="{{ route('saran.indexpetugas') }}" class="block"class="block">
                    <li class="flex items-center px-4 py-2 hover:bg-purple-200 rounded-xl space-x-4 {{ request()->is('saran-petugas') ? 'bg-purple-400 text-white' : 'hover:bg-purple-300' }}">
