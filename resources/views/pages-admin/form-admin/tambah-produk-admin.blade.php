    ...
    <form>
        ...
        <h2 class="text-xl font-semibold text-gray-700 pt-4 text-center">Tambah Produk</h2>
            <div class="">
                <div class="mt-1 grid grid-cols-1 gap-x-6 gap-y-2 md:grid-cols-2">
                    ...
                    <div class="col-span-full mt-1">
                        ...
                        <input type="text" id="" class="block text-sm w-full text-gray-600 py-1.5 pl-2 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-md placeholder:text-gray-400" placeholder="Silahkan isi nama produk">
                    </div>

                    <div class="col-span-full mt-1">
                        <label for="" class="block font-medium leading-6 text-gray-700">Harga</label>
                        <input type="text" id="" class="block text-sm w-full text-gray-600 py-1.5 pl-2 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-md placeholder:text-gray-400" placeholder="Silahkan isi harga produk">
                    </div>

                    <div class="col-span-full mt-1">
                        <label for="" class="block font-medium leading-6 text-gray-700">Stok</label>
                        <input type="text" id="" class="block text-sm w-full text-gray-600 py-1.5 pl-2 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-md placeholder:text-gray-400" placeholder="Silahkan isi stok produk">
                    </div>

                    <div class="col-span-full mt-1">
                    <label for="kategori" class="block font-medium leading-6 text-gray-700">Kategori</label>
                    <select id="kategori" name="kategori" class="block w-full text-sm text-gray-600 py-1.5 pl-2 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-md">
            ...
            <div class="mt-6 mb-10 flex justify-end gap-x-6">
                ...
                <button id="submitbutton" type="button" class="px-2 py-1.5 bg-indigo-600 text-white rounded-md hover:bg-indigo-500 focus:ring focus:ring-blue-300 mb-6">Tambah</button>
            </div>
        </div>
    </form>
    </div>
