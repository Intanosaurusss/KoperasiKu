                        ...
                        <div class="mt-1 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-6">
                            <div class="text-center">
                                ...
                                <div class="mt-4 flex leading-6 text-gray-600">
                                    <label for="foto_produk" class="cursor-pointer rounded-md bg-white font-semibold text-purple-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-purple-600 focus-within:ring-offset-2 hover:text-purple-600">
