...
<div class="p-4 bg-white rounded-lg shadow-md">
    <div class="mb-4">
        ...
        <p class="text-gray-700 text-sm">24 Oktober 2024</p>
    </div>
    <div class="mb-4">
        <p class="font-medium text-gray-700">Deskripsi:</p>
        <p class="text-gray-700 text-sm">Membeli : chocolatos 1 pack 10.000, nabati chocolatos 1 pack 10.000 </p>
    </div>
    <div>
        <p class="font-medium text-gray-700">Total Pengeluaran:</p>
        <p class="text-red-400 text-sm">Rp 20.000</p> <!-- Ganti dengan nilai total pengeluaran -->
    </div>
</div>
