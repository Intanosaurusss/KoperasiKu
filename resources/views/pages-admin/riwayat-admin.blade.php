...
<div class="p-2">
    ...
    <!-- ini form input tanggal cetak riwayat -->
    <div class="bg-white p-6 rounded-lg max-w-lg w-full">
        <form class="flex flex-col sm:flex-row sm:space-x-4">
            <div class="flex flex-col flex-grow">
                <label for="date-start" class="mb-1 text-gray-700">Tanggal Mulai:</label>
                <input type="date" id="date-start" class="border border-gray-300 rounded-md p-1" required>
            </div>
            <div class="flex flex-col flex-grow">
                <label for="date-end" class="mb-1 text-gray-700">Tanggal Selesai:</label>
                <input type="date" id="date-end" class="border border-gray-300 rounded-md p-1" required>
            </div>
            <div class="flex flex-col mt-4 sm:mt-0 md:mt-3">
