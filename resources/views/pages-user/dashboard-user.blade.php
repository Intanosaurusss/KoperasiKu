...
<div class="p-2">
    ...
    @if (session('success'))
        <div id="flash-message" class="bg-green-100 border border-green-400 text-green-700 p-2 rounded mt-2" role="alert">
    ...
    @if (session('warning'))
        <div id="flash-message" class="bg-yellow-100 border border-yellow-400 text-yellow-700 p-2 rounded mt-2" role="alert">
