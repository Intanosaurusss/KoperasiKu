...
class TransaksiPetugasController extends Controller
{
    public function indexpetugas(Request $request)
    {
        ...
        return view('pages-petugas.transaksi-petugas', compact('keranjang', 'idMember', 'formattedSubtotal'));
    }

    public function addtransaksitokeranjangbypetugas(Request $request)
    {
        // Validasi input
        $request->validate([
    ...
    public function hapuskeranjangbypetugas(Request $request)
    {
    ...
    public function checkoutbypetugas(Request $request)
    {
    ...
    public function paymentsuccessbypetugas(Request $request)
    {
     ...
     public function searchidmemberbypetugas(Request $request)
     {
         // Validasi input
         $request->validate([
     ...
     public function searchprodukbypetugas(Request $request)
     {
         // Validasi input
         $request->validate([
